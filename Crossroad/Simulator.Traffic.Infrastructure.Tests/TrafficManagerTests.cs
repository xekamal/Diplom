...
namespace Simulator.Traffic.Infrastructure.Tests
{
    ...
    public class TrafficManagerTests
    {
        ...
        public void CheckAllLinesAndRecalculate()
        {
            ...
            var leftToRightTrafficFlow = new TrafficFlow { TrafficDensity = leftToRightDensity, TrafficSpeed = leftToRightSpeed };
            ...
            var leftToDownTrafficFlow = new TrafficFlow { TrafficDensity = leftToDownDensity, TrafficSpeed = leftToDownSpeed };
            ...
            var rightToDownTrafficFlow = new TrafficFlow { TrafficDensity = rightToDownDensity, TrafficSpeed = rightToDownSpeed };
            ...
            var rightToLeftTrafficFlow = new TrafficFlow { TrafficDensity = rightToLeftDensity, TrafficSpeed = rightToLeftSpeed };
            ...
            var rightToUpTrafficFlow = new TrafficFlow { TrafficDensity = rightToUpDensity, TrafficSpeed = rightToUpSpeed };
            ...
            var upToRightTrafficFlow = new TrafficFlow { TrafficDensity = upToRightDensity, TrafficSpeed = upToRightSpeed };
            ...
            var downToLeftTrafficFlow = new TrafficFlow { TrafficDensity = downToLeftDensity, TrafficSpeed = downToLeftSpeed };
            ...
            var downToRightTrafficFlow = new TrafficFlow { TrafficDensity = downToRightDensity, TrafficSpeed = downToRightSpeed };
